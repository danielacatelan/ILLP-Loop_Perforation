...
.LBB18_31:                              # %for.inc1325
	...
	mv	s4, a0
	bge	a0, a6, .LBB18_92
.LBB18_32:                              # %for.cond366.preheader
                                        # =>This Loop Header: Depth=1
...
# %bb.33:                               # %for.body370.lr.ph
	...
	addi	s8, zero, 7
	j	.LBB18_37
.LBB18_34:                              #   in Loop: Header=BB18_37 Depth=2
	lw	s9, 136(sp)
.LBB18_35:                              #   in Loop: Header=BB18_37 Depth=2
	lw	s1, 160(sp)
.LBB18_36:                              # %for.inc1322
...
# %bb.85:                               # %land.lhs.true787
	...
	lw	a1, 12(a1)
	bge	a0, a1, .LBB18_89
.LBB18_86:                              #   in Loop: Header=BB18_37 Depth=2
	lw	s9, 136(sp)
	lw	s1, 160(sp)
	lw	a5, 156(sp)
	j	.LBB18_88
.LBB18_87:                              #   in Loop: Header=BB18_37 Depth=2
	lw	s9, 136(sp)
	lw	s1, 160(sp)
.LBB18_88:                              # %for.inc1322
                                        #   in Loop: Header=BB18_37 Depth=2
	lw	a6, 152(sp)
	addi	a7, zero, 8
	lw	t0, 128(sp)
...
# %bb.0:                                # %entry
	...
	mv	s1, a1
	lui	a0, %hi(.L.str34)
	addi	a0, a0, %lo(.L.str34)
	lui	a1, %hi(.L.str135)
	addi	a1, a1, %lo(.L.str135)
	call	fopen
	mv	s0, a0
	lui	a0, %hi(.L.str236)
	addi	a1, a0, %lo(.L.str236)
	mv	a0, s0
	mv	a2, s2
	mv	a3, s1
	call	fprintf
